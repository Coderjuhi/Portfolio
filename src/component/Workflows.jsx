...
export default function Workflows() {
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-20">
                    ...
                    <span
                     className=
                     "inline-block px-2 py-1 font-semibold rounded-full bg-white/60 backdrop-blur-lg border border-gray-300 text-blue-500 text-xs tracking-[0.2em] shadow">
                        Workflow
                    </span>
                    <h2 className="mt-5 text-4xl  md:text-5xl text-black font-bold max-w-2xl">How a feature travels from idea to production</h2>
