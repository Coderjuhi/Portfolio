...
const Home = () => {
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-4 lg:px-8 pt-20 pb-20">
        <div className="grid lg:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <div className="text-3xl font-bold text-slate-700 mt-6">
            ...
            <p className="mt-8 text-md text-slate-600 leading-8 max-w-xl">
            ...
            <div className="flex flex-wrap gap-5 mt-10">
              ...
              <button className="px-7 py-3 rounded-full bg-blue-500 text-white font-semibold shadow-lg hover:scale-105 duration-300">
                View Projects
              </button>

              <button className="flex items-center gap-3 px-7 py-3 rounded-full bg-white shadow-lg hover:scale-105 duration-300">
                <FaDownload />
                Resume
              </button>

              <button className="flex items-center gap-3 px-7 py-3 rounded-full border bg-white hover:bg-blue-500 hover:text-white duration-300">
                <FaEnvelope />
                Contact
              </button>
