    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-8 pt-20 items-center">
          ...
          <h1 className="mt-5 text-5xl text-black font-bold max-w-3xl">Building products and proving they work</h1>
          ...
          <div className=" grid lg:grid-cols-2 max-w-7xl gap-16 mt-14   ">
            ...
            <div className="flex flex-col gap-6">
              {/* Card 1 */}
              <div className="bg-white rounded-3xl shadow-xl p-5 flex items-start gap-4">
                <div className="h-10 w-14 rounded-full bg-blue-500 flex items-center justify-center text-white">
                  <Rocket size={26} />
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600 text-sm">
                    From Java fundamentals to full-stack MERN applications
                    with authentication, dashboards and REST APIs.
                  </p>
                </div>
              </div>

              {/* Card 2 */}
              <div className="bg-white rounded-3xl shadow-xl p-5 flex items-start gap-5">
                <div className="h-10 w-14 rounded-full bg-blue-500 flex items-center justify-center text-white">
                  <ShieldCheck size={26} />
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600 text-sm">
                    Structured test scenarios, regression suites, API
                    validation and automation to ensure reliable software.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl shadow-xl p-5 flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600 text-sm">
                    Grow into an SDET-ready engineer by combining strong
                    development skills with automation testing and product
                    engineering.
                  </p>
                </div>
              </div>
